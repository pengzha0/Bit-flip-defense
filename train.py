...
def main():
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        # train for one epoch
        train_acc, train_los = train(train_loader, net, criterion, optimizer,attacker,
                                     epoch, log)
...
def perform_attack(attacker, model, train_loader,
                   N_iter):
...
def train(train_loader, model, criterion, optimizer, attacker, epoch, log):
